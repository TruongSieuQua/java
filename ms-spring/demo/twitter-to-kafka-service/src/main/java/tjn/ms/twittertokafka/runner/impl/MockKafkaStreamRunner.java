package tjn.ms.twittertokafka.runner.impl;
...
import tjn.ms.twittertokafka.exception.TwitterToKafkaServiceException;
import tjn.ms.twittertokafka.listener.TwitterKafkaStatusListener;
...
public class MockKafkaStreamRunner implements StreamRunner {
    ...
    @Override
    public void start() {
        String[] keywords = twitterToKafkaServiceProperties.twitterKeywords().toArray(new String[0]);
        final int minTweetLength = twitterToKafkaServiceProperties.mockMinTweetLength();
        final int maxTweetLength = twitterToKafkaServiceProperties.mockMaxTweetLength();
        long sleepTimeMs = twitterToKafkaServiceProperties.mockSleepMs();
