...
import com.foodordersystem.orderingservicedomain.dto.create.OrderItem;
...
public class OrderApplicationServiceTest {
    ...
    private final UUID PRODUCT_1_ID = UUID.fromString("d215b5f8-0249-4dc5-89a3-51fd148cfb48");
    private final UUID PRODUCT_2_ID = UUID.fromString("d215b5f8-0249-4dc5-89a3-51fd148cfb49");
    ...
    public void init() {
        ...
        Restaurant restaurantResponse = Restaurant.builder()
                ...
                .products(List.of(new Product(new ProductId(PRODUCT_1_ID), "product-1", new Money(new BigDecimal("50.00"))),
                        new Product(new ProductId(PRODUCT_2_ID), "product-2", new Money(new BigDecimal("50.00")))))
                .active(true)
                .build();
    ...
    public void testCreateOrderWithWrongProductPrice() {
        ...
        assertEquals("Order item price 60.00 is not valid for product " + PRODUCT_1_ID + "!", orderDomainException.getMessage());
    }
